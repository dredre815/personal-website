    ...
    <ProjectsContainer>
      <ProjectCard>
        ...
        <DetailsButton onClick={() => toggleDetails('melbourneDashboard')}>
          {openDetails.melbourneDashboard ? '< Less Details />' : '< More Details />'}
        </DetailsButton>

        <ProjectDetails isOpen={openDetails.melbourneDashboard}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Key Features:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Technical Implementation:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Data Analytics:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <ProjectDetails isOpen={openDetails.lyonville}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Core Features:</h4>
          <FeatureList>
            <li>Interactive community event management system</li>
            <li>Comprehensive content management for local news and updates</li>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Development Standards:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <ProjectDetails isOpen={openDetails.splendorAI}>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Strategic Components:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <ProjectDetails isOpen={openDetails.whiteBoard}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Drawing Tools:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Collaboration Features:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <DetailsButton onClick={() => toggleDetails('dictionaryServer')}>
          {openDetails.dictionaryServer ? '< Less Details />' : '< More Details />'}
        </DetailsButton>

        <ProjectDetails isOpen={openDetails.dictionaryServer}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Core Features:</h4>
          <FeatureList>
            <li>Multi-threaded server with custom thread pool implementation</li>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Architecture Components:</h4>
          <FeatureList>
            <li>Server with GUI control panel and core dictionary operations</li>
      ...
      <ProjectCard>
        ...
        <ProjectDetails isOpen={openDetails.rpcSystem}>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>System Components:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <DetailsButton onClick={() => toggleDetails('processManagement')}>
          {openDetails.processManagement ? '< Less Details />' : '< More Details />'}
        </DetailsButton>

        <ProjectDetails isOpen={openDetails.processManagement}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Scheduling Algorithms:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Memory Management:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Technical Features:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <DetailsButton onClick={() => toggleDetails('pacmanTorusVerse')}>
          {openDetails.pacmanTorusVerse ? '< Less Details />' : '< More Details />'}
        </DetailsButton>

        <ProjectDetails isOpen={openDetails.pacmanTorusVerse}>
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Game Features:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Map Editor Features:</h4>
          <FeatureList>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Technical Highlights:</h4>
          <FeatureList>
      ...
      <ProjectCard>
        ...
        <DetailsButton onClick={() => toggleDetails('shadowDimension')}>
          {openDetails.shadowDimension ? '< Less Details />' : '< More Details />'}
        </DetailsButton>
        ...
        <ProjectDetails isOpen={openDetails.shadowDimension}>
          ...
          <h4 style={{ color: 'var(--primary)', marginTop: '1rem' }}>Controls:</h4>
          <FeatureList>
